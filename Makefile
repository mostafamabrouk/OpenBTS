...
ACLOCAL = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run autoconf
AUTOHEADER = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run autoheader
AUTOMAKE = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run automake-1.9
AWK = mawk
CC = gcc
CCAS = gcc
CCASFLAGS = -g -O2
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /media/Data/Graduation/openbts-2.6.0Mamou/missing --run makeinfo
OBJDUMP = objdump
OBJEXT = o
...
PACKAGE_STRING = openbts 2.6.0Mamou
PACKAGE_TARNAME = openbts
PACKAGE_VERSION = 2.6.0Mamou
PATH_SEPARATOR = :
...
SHELL = /bin/bash
STRIP = strip
USRP_CFLAGS = -I/usr/local/include  
USRP_LIBS = -L/usr/local/lib -lusrp -lusb  
VERSION = 2.6.0Mamou
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = f77
...
install_sh = /media/Data/Graduation/openbts-2.6.0Mamou/install-sh
